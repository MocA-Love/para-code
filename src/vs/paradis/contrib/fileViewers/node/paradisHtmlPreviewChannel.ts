...
export class ParadisHtmlPreviewChannel implements IServerChannel<string> {
 ...
 */
export function registerParadisHtmlPreview(server: IPCServer<string>): IDisposable {
	const channel = new ParadisHtmlPreviewChannel();
