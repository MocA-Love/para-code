...
import { ActivityBarPosition, IWorkbenchLayoutService, LayoutSettings, Parts, Position, FLOATING_PANEL_INNER_MARGIN, FLOATING_PANEL_MARGIN, isFloatingTopEdgeExposed, SINGLE_WINDOW_PARTS } from '../../../services/layout/browser/layoutService.js'; // PARA-PATCH: +SINGLE_WINDOW_PARTS (parameterized part id for the auxiliary activity bar, see constructor)
