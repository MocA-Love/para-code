...
const agentCliTitlePatterns: ReadonlyMap<GeneralShellType, RegExp> = new Map([
	...
	// Upstream keeps this commented out because codex does not report an osc title on its own.
...
export class TerminalLabelComputer extends Disposable {
	...
	// PARA-PATCH: automatic Codex titles — 'transientTitle' is a fork-only key in this Pick (see CLAUDE.md)
	refreshLabel(instance: Pick<ITerminalInstance, 'shellLaunchConfig' | 'shellType' | 'cwd' | 'fixedCols' | 'fixedRows' | 'initialCwd' | 'processName' | 'sequence' | 'userHome' | 'workspaceFolder' | 'staticTitle' | 'transientTitle' | 'capabilities' | 'title' | 'description' | 'os'>, reset?: boolean): void {
	...
	computeLabel(
		// PARA-PATCH: automatic Codex titles — 'transientTitle' is a fork-only key in this Pick (see CLAUDE.md)
		instance: Pick<ITerminalInstance, 'shellLaunchConfig' | 'shellType' | 'cwd' | 'fixedCols' | 'fixedRows' | 'initialCwd' | 'processName' | 'sequence' | 'userHome' | 'workspaceFolder' | 'staticTitle' | 'transientTitle' | 'capabilities' | 'title' | 'description' | 'progressState' | 'os'>,
