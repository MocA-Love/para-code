...
class TestBrowserViewWorkbenchService implements IBrowserViewWorkbenchService {
	...
	// PARA-PATCH: mirror the real service's initialization barrier (resolves immediately in tests)
	readonly whenInitialized: Promise<boolean> = Promise.resolve(true);
