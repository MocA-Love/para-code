 ...
 */
export function HeaderEdgeFade({ id = 'paraHeaderFade' }: {
			...
			<Svg width="100%" height="100%">
				<Defs>
					<SvgGradient id={id} x1="0" y1="0" x2="0" y2="1">
						<Stop offset="0" stopColor={colors.bg} stopOpacity="0.94" />
						<Stop offset="0.58" stopColor={colors.bg} stopOpacity="0.55" />
