...
export const MOBILE_CHANGELOG: readonly MobileRelease[] = [
	{
		...
		items: [
			...
			},
			{
				...
				body: 'Claude や Codex の起動、ターミナルやワークツリーの作成、スペースのメモ、並び替えと絞り込みをここにまとめました。ボタンと繋がった1つの塊として出ます。一覧の上にあった並び替えのバーは無くなり、そのぶん本文が上から始まります。',
				tone: 'purple',
			},
			{
				icon: 'funnel-outline',
			...
			},
			{
				...
				body: '浅く引くと開いたまま止まるので、狙って押せます。引き切ったときに実行されるのはアーカイブだけで、削除は必ずボタンを押して確認します。開いた行は右へ引き戻すか、別の行を開くと閉じます。',
				tone: 'green',
			},
			{
